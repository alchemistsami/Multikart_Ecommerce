    ...
    return (
        <>
            <div className='home-nav-bar-drop-down-items'
                id='pages-nav-bar-drop-down-items-id'
                ref={dropdownRef}
            ...
            >
                <p onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
                    ...
                    <svg className='home-nav-bar-drop-down-items-svg'
                        id='pages-nav-bar-drop-down-items-svg-id'
                ...
                {isDropdownOpen && (
                    <ul
                        ...
                        id='pages-dropdown-menu-class-id'
                        style={{
                            position: "absolute",
                            zIndex: 1,
                            listStyle: 'none'
                    ...
                    >
                        <li className='nav-bar-dropdown-pages' id='pages-nav-bar-dropdown-pages-id'>Login</li>
